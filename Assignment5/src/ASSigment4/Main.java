...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Connection conn= DriverManager.getConnection(URL,"phamanhadmin","anhanh");
            System.out.println("Co ton tai nguoi dung nay ! ");
            Statement statement =conn.createStatement();
            String insert_sql="INSERT INTO user (id,username,email,password,status)"+ "VALUES('3305895','','badaobui anh14@yahoo.com','galam',0)";
